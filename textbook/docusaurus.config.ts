    ...
    [
      'classic',
      {
        docs: {
          ...
          sidebarPath: './sidebars.ts',  // This is correct
        },
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/jawwad-ali/physical-ai-textbook',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      style: 'dark',
      copyright: `Physical AI & Humanoid Robotics Textbook © ${new Date().getFullYear()}`,
    },
    prism: {
